export const ADD_TO_CART = 'store/cart/ADD_TO_CART';
export const REMOVE_FROM_CART = 'store/cart/REMOVE_FROM_CART';
...
export const SET_DELIVERY_DETAILS ='store/userInfo/SET_DELIVERY_DETAILS';
